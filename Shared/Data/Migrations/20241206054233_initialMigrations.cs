        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalTable: "NameTags",
                        principalColumn: "NameTagId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductNameTags_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    TotalAmount = table.Column<decimal>(type: "decimal(9,0)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "3905a8d3-d799-4a4e-a790-c42e026f7087", "2", "Staff", "Staff" },
                    { "db1d0634-f0c3-4291-bea4-1b0b919987db", "1", "Admin", "Admin" },
                    { "fa1df9ef-616b-4903-9188-880cc91654ea", "3", "Customer", "Customer" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductNameTags_ProductId",
                table: "ProductNameTags",
                column: "ProductId");
